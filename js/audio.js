...
GW.Audio = (function(){
  ...
  function playPickup(){
    ...
    [0,0.07].forEach((d,i)=>{
      ...
      osc.connect(g); g.connect(actx.destination); osc.start(t+d); osc.stop(t+d+0.15);
    });
  }
  ...
  function playChord(up){
    ...
    freqs.forEach((f,i)=>{
      ...
      osc.connect(g); g.connect(actx.destination); osc.start(t+d); osc.stop(t+d+0.32);
    });
  }
  ...
  return {
    ...
    playFootstep, playDamage, playPickup, playBeep, playChord, playUIClick
  };
})();
